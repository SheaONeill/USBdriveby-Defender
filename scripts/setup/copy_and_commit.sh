...
echo "Copying ${LOCAL_RULES_PATH}63-usb-kbd.rules ${GIT_REPO_PATH}${GIT_REPO_RULES_PATH}"
echo "Copying ${LOCAL_RULES_PATH}81-usb-flash.rules ${GIT_REPO_PATH}${GIT_REPO_RULES_PATH}"
